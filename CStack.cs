...
namespace MolkFreeCalc
{
    ...
    public class CStack
    {
        ...
        public string entry;
        public double[] storedNumbers = {0, 0, 0, 0, 0, 0, 0, 0 };
        public double numToStore;
        public string index = null;
        public string indexStr = null;
        ...
        /* METHOD: SetVar
         * PURPOSE: Load double in to memmory, takes from X
         * PARAMETERS: --
         * RETURNS: The number we want to store
         * FEATURES: Original X still stays the same
         */
        public double SetVar()
        {
            numToStore = X;
            return X;
        ...
        /* METHOD: GetVar
         * PURPOSE: Recall variable from our array
         * PARAMETERS: index
         * RETURNS: --
         */
        public void GetVar(string i)
        {
            switch (i)
            {
                case "A": recall = storedNumbers[0]; break;
                case "B": recall = storedNumbers[1]; break;
                case "C": recall = storedNumbers[2]; break;
                case "D": recall = storedNumbers[3]; break;
                case "E": recall = storedNumbers[4]; break;
                case "F": recall = storedNumbers[5]; break;
                case "G": recall = storedNumbers[6]; break;
                case "H": recall = storedNumbers[7]; break;

            }
        }
        
         /* METHOD: MemoryStore
         * PURPOSE: Saves our variable to memmory
         * PARAMETERS: index
         * RETURNS: --
         */
        public void MemoryStore(string i)
        {
            switch (i)
            {
                case "A": storedNumbers[0] = X; break;
                case "B": storedNumbers[1] = X; break;
                case "C": storedNumbers[2] = X; break;
                case "D": storedNumbers[3] = X; break;
                case "E": storedNumbers[4] = X; break;
                case "F": storedNumbers[5] = X; break;
                case "G": storedNumbers[6] = X; break;
                case "H": storedNumbers[7] = X; break;
